describe('Arithmetic', function () {
    ...
    describe('Multiplication', function () {
        ...
        it('multiplies with mixed exponent', function (done) {
            request.get('/arithmetic?operation=multiply&operand1=1.2e5&operand2=1.2e-5')
                .expect(200)
                .end(function (err, res) {
    ...
    describe('Modulus', function () {
        it('modulus two positive integers', function (done) {
            request.get('/arithmetic?operation=modulus&operand1=21&operand2=21')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({result: 0});
                    done();
        ...
        it('modulus a negative integer by a positive integer', function (done) {
            request.get('/arithmetic?operation=modulus&operand1=21&operand2=-42')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({result: 21});
                    done();
        ...
        it('modulus two negative integers', function (done) {
            request.get('/arithmetic?operation=modulus&operand1=-21&operand2=-21')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({result: 0});
        ...
        it('modulus an integer by a floating point number', function (done) {
            request.get('/arithmetic?operation=modulus&operand1=2.5&operand2=-5')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({result: 2.5});
                    done();
        ...
        it('modulus with negative exponent', function (done) {
            request.get('/arithmetic?operation=modulus&operand1=1.2e-5&operand2=-1.2e-5')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({result: 0});
                    done();
